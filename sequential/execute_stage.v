...
2'b00: alu_input1 = read_data1;        // no forwarding
2'b10: alu_input1 = EX_MEM_alu_result; // EX/MEM → EX
2'b01: alu_input1 = MEM_WB_write_data; // MEM/WB → EX
...
////////////////////////////////////////////////////////////
// ALU instance (YOUR EXISTING ALU)
////////////////////////////////////////////////////////////
wire cout;
wire carry_flag;
wire overflow_flag;
